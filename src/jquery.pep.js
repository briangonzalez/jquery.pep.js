...
;(function ( $, window, undefined ) {
  ...
  defaults = {
    ...
    forceJSAnimateEverywhere: false,                                        // DO NOT USE: this is subject to come/go. Use at your own risk.
  ...
  Pep.prototype.ease = function(ev){
    ...
    var jsAnimateFallback = !this.cssAnimationsSupported() || this.options.forceJSAnimateEverywhere;
